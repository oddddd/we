 ...
 */
class Model_WeShare extends PhalApi_Model_NotORM
{
    /**
    ...
    {
        try {
            $sql = "select count(*) as page from we_share {$sql}";
            $list = $this->getORM()->queryAll($sql);
    ...
    {
        try {
            $sql = "delete from we_share where id = {$data['id']}";
