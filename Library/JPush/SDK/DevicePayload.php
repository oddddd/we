...
class DevicePayload {
    ...
    public function getDevices($registrationId) {
        ...
        $response = $this->client->_request($url, JPush_Lite::HTTP_GET);
    ...
    public function updateDevice($registrationId, $alias = null, $mobile=null, $addTags = null, $removeTags = null) {
        ...
        $url = DevicePayload::DEVICE_URL . $registrationId;
        $response = $this->client->_request($url, JPush_Lite::HTTP_POST, json_encode($payload));
        return $this->__processResp($response);
    }

    public function getTags() {
        $response = $this->client->_request(DevicePayload::TAG_URL, JPush_Lite::HTTP_GET);
        return $this->__processResp($response);
    }
    ...
    public function deleteTag($tag) {
        ...
        $url = DevicePayload::TAG_URL . $tag;
        $response = $this->client->_request($url, JPush_Lite::HTTP_DELETE);
        return $this->__processResp($response);
    }
    ...
    public function getDevicesStatus($registrationId) {
        ...
        $response = $this->client->_request(DevicePayload::DEVICE_STATUS_URL, JPush_Lite::HTTP_POST, json_encode($payload));
