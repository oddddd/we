...
//        print_r([$_POST,$_FILES]);exit;
        ...
        $this->filterCheck('parameterFilter');

        $this->filterCheck('sessionFilter');
...
```
     ...
     */
    protected function filterCheck($filter='filter') {
    ...
    public function allParams(){
        ...
        if(isset($allParams['accessToken']))
            unset($allParams['accessToken']);
        if(isset($allParams['service']))
            unset($allParams['service']);
        if(isset($allParams['backToken']))
            unset($allParams['backToken']);
        return $allParams;
    }
}
